...
export class ChatPanelService {
    ...
    getChat(contactId): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (chatItem) {
                this.httpClient.get('api/chat-panel-chats/' + chatItem.chatId)
                    .subscribe((chat) => {
    ...
    createNewChat(contactId): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.httpClient.post('api/chat-panel-chats', { ...chat })
                .subscribe((res) => {
                    // Post the updated user data to the server
                    this.httpClient.post('api/chat-panel-user/' + this.user.id, this.user)
                        .subscribe(() => {
                            // Resolve the promise
                            resolve(res);
                        });
    ...
    updateChat(chatId, dialog): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            // this.httpClient.post('api/chat-panel-chats/' + chatId, newData)
    ...
    getUser(): Promise<any> {
        return new Promise((resolve, reject) => {
            this.httpClient.get('api/chat-panel-user')
