...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  @Transactional
  public UserDetails activeUserByCode(String activeCode) {
    User user = userRepository.findByActivationCode(activeCode).orElseThrow(() -> new ResourceNotFoundException("User"
